...
<body style="overflow-x: hidden;">
    ...
    <div class="headcontainer">
        <div>
            <img class="animate__animated animate__zoomInRight" id="imgprogrammer" src="https://i.ibb.co/g76L0L2/programmerstyle.png" alt="ProgrammerCocoon">
    ...
    <?php 
        include 'navbar.php';
    ?>
    <script src='scripts/push2.js'></script>
    <script src='scripts/languages.js'></script>
    <script src='scripts/app.js'></script>
    <script src="scripts/changedpush.js"></script>
    <!-- <script>
